//Various attempts to get m1 balancing and TE estimations close as possible before having to start a proper search.

void get_m1params_v4(float *m, float gmax, double smax, double tmax, float *m1_params, bool debug)
{

    double c0 [24] = {2.8193284754, 0.517285115073, 0.00318474982152, -0.00750197738118, -0.00162281097653, 0.0153170460615, -3.44532714373e-05, 0.00480459246126, -0.000563905836448, 0.00259678467957, 0.0224764786883, -0.000719327727422, -0.0014505107242, 0.000180422425305, 0.000209849265582, -0.0529593419345, 0.0171543794826, 0.000395125207126, 0.012276387247, -9.65238199263e-05, -0.00127180225511, 8.5897091374e-07, -8.35158710664, 5.31808654256};
    double c1 [24] = {6.37382314823, 0.00943834371467, 0.000777259565957, 0.514399136744, 0.00620246557491, 0.00760314133923, -0.000573281650522, 0.000866220722428, 0.00168530075553, -0.00172203576301, 0.000169168870485, 0.0202497884434, -0.000364909791455, -0.00115470150359, -0.000315975895488, -0.0851990638296, 0.352264151482, -0.005286388605, -0.110766859959, 0.000978000444688, -0.0468734287422, 0.000139633254169, -3.36950541304, 1.81644927967};
    double c2 [24] = {4.41263520657, 0.00489976297056, 0.000220714407482, 0.0155594915974, 0.000189883157639, 0.504178407479, 0.0040842236721, 0.000613140503256, 0.00278611016569, -0.00104765212866, -0.000198058879604, -0.0016568190523, 0.0232204027727, -0.000686890562361, -0.000223565399143, -0.0798343045964, 0.253209573094, -0.00356601544326, -0.049716265069, 0.00043798019057, -0.0343050978024, 0.000103286518233, -3.07135229237, 1.51418132706};
    double cn [24] = {55.6741949195, -0.0227600700192, 0.00217057170166, 0.0808412966116, 0.00882449013054, 0.0753009234195, -0.0013054278374, 0.00123842639125, 0.00207121146344, 0.000472974417287, -0.000761211635466, -0.0106818594036, -0.00247102279131, -0.00380301884579, -0.000769229841208, -0.490344660572, 2.87229440087, -0.0259468286976, -0.277547085468, 0.00248567483421, -0.195286216341, 0.000609437723889, -30.4849462351, 17.5659823209};  
    ...
    for (int i = 0; i < 24; i++){
        m1_params[0] += r[i] * c0[i];
        m1_params[1] += r[i] * c1[i];
        m1_params[2] += r[i] * c2[i];
        m1_params[3] += r[i] * cn[i];
    }
